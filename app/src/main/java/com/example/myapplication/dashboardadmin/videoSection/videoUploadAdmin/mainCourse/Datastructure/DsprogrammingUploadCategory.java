...
public class DsprogrammingUploadCategory extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dsprogramming_upload_category);
    ...
    private void validateDatat() {
        ...
        if(TextUtils.isEmpty(ModuleName)){
            Toast.makeText(DsprogrammingUploadCategory.this, "Enter The Module Name" , Toast.LENGTH_SHORT).show();
        }else if(TextUtils.isEmpty(videoTitleName)){
            Toast.makeText(DsprogrammingUploadCategory.this, "Enter The Video Title" , Toast.LENGTH_SHORT).show();

        }else if(TextUtils.isEmpty(TodayTotalVideoCount)){
            Toast.makeText(DsprogrammingUploadCategory.this, "Enter The Total Video Number" , Toast.LENGTH_SHORT).show();

        }else if(TextUtils.isEmpty(InstructorNAme)){
            Toast.makeText(DsprogrammingUploadCategory.this, "Enter The Instructor Name" , Toast.LENGTH_SHORT).show();
        }else{
        ...
        reference.child("DataStructure")
                ...
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void unused) {
                        ...
                        Toast.makeText(DsprogrammingUploadCategory.this, "Uploaded Module Successfully ", Toast.LENGTH_SHORT).show();
                    ...
                    public void onFailure(@NonNull Exception e) {
                        progressDialog.dismiss();
                        Toast.makeText(DsprogrammingUploadCategory.this,  ""+e.getMessage(), Toast.LENGTH_SHORT).show();
