...
public class ModelDsModule {

    String   InstructorName = "",  Module = "" , TotalVideo ="", VideoTitle ="" , id = "" , uid = "";
    long timeStamp ;

    public ModelDsModule(){

    }

    public ModelDsModule(String instructorName, String module, String totalVideo, String videoTitle, String id, String uid, long timeStamp) {
