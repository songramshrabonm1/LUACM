...
public class AdapterCppModuleClasses extends RecyclerView.Adapter<AdapterCppModuleClasses.ViewHolder> {


    ArrayList<CppprogrammingModelClasses> moduleClassesCategory = new ArrayList<>();
    private Context context;
    private ProgressDialog progressDialog;
    private String UserType = "";

    public AdapterCppModuleClasses(ArrayList<CppprogrammingModelClasses> moduleClassesCategory, Context context  , String UserType) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        CppprogrammingModelClasses modelClasses = moduleClassesCategory.get(position);
        ...
        if(UserType.equals("ADMIN")) {
            ...
            holder.editBtn.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    Intent intent = new Intent(context, CppprogrammingModuleClassesEdit.class);
    ...
    private void DeleteClasss(CppprogrammingModelClasses modelClasses, ViewHolder holder) {
