...
public class DailyModuleClassesEdit extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_daily_module_classes_edit);
        ...
        updatedDriveLinkBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(DailyModuleClassesEdit.this);
    ...
    private void validateData() {
        ...
        if(TextUtils.isEmpty(updatedDriveLink)){
            Toast.makeText(DailyModuleClassesEdit.this, "Drive link empty" , Toast.LENGTH_SHORT).show();
        }else if(TextUtils.isEmpty(updatedClassName)){
            Toast.makeText(DailyModuleClassesEdit.this, "class Name empty" , Toast.LENGTH_SHORT).show();
        }else{
        ...
        ref.child("DailyContest")
                ...
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void unused) {
                        ...
                        Toast.makeText(DailyModuleClassesEdit.this, "Updated Drive Link And Class Number Successfully" , Toast.LENGTH_SHORT).show();
                    ...
                    public void onFailure(@NonNull Exception e) {
                        progressDialog.dismiss();
                        Toast.makeText(DailyModuleClassesEdit.this, ""+e.getMessage() , Toast.LENGTH_SHORT).show();
