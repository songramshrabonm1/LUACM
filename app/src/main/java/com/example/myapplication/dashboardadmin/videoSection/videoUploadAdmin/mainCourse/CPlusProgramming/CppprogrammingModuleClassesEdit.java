...
import com.example.myapplication.dashboardadmin.videoSection.videoUploadAdmin.mainCourse.CprogrammingModuleClassesEdit;
...
public class CppprogrammingModuleClassesEdit extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cppprogramming_module_classes_edit);
        ...
        updatedDriveLinkBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(CppprogrammingModuleClassesEdit.this);
    ...
    private void validateData() {
        ...
        if(TextUtils.isEmpty(updatedDriveLink)){
            Toast.makeText(CppprogrammingModuleClassesEdit.this, "Drive link empty" , Toast.LENGTH_SHORT).show();
        }else if(TextUtils.isEmpty(updatedClassName)){
            Toast.makeText(CppprogrammingModuleClassesEdit.this, "class Name empty" , Toast.LENGTH_SHORT).show();
        }else{
        ...
        ref.child("CPlusProgramming")
                ...
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void unused) {
                        ...
                        Toast.makeText(CppprogrammingModuleClassesEdit.this, "Updated Drive Link And Class Number Successfully" , Toast.LENGTH_SHORT).show();
                    ...
                    public void onFailure(@NonNull Exception e) {
                        progressDialog.dismiss();
                        Toast.makeText(CppprogrammingModuleClassesEdit.this, ""+e.getMessage() , Toast.LENGTH_SHORT).show();
