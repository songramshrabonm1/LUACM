...
public class ConceptualUploadCategoryEdit extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_conceptual_upload_category_edit);
    ...
    private void validatedData() {
        ...
        if(TextUtils.isEmpty(UpdateModule)){
            Toast.makeText(ConceptualUploadCategoryEdit.this, "Update Module" , Toast.LENGTH_SHORT).show();
        }else if(TextUtils.isEmpty(VideoTitle)){
            Toast.makeText(ConceptualUploadCategoryEdit.this, "Update Video Title" , Toast.LENGTH_SHORT).show();
        }else if(TextUtils.isEmpty(UpdateTotalVideoCnt)){
            Toast.makeText(ConceptualUploadCategoryEdit.this, "Update Total Video count" , Toast.LENGTH_SHORT).show();
        }else if(TextUtils.isEmpty(UpdateInstructorName)){
            Toast.makeText(ConceptualUploadCategoryEdit.this, "Update Instructor Name" , Toast.LENGTH_SHORT).show();
        ...
        ref.child("Conceptual")
                ...
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void unused) {
                        ...
                        Toast.makeText(ConceptualUploadCategoryEdit.this, "Updating Module succefully..." , Toast.LENGTH_SHORT).show();
                    ...
                    public void onFailure(@NonNull Exception e) {
                        ...
                        progressDialog.dismiss();
                        Toast.makeText(ConceptualUploadCategoryEdit.this, ""+e.getMessage() , Toast.LENGTH_SHORT).show();
