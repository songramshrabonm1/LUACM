...
public class DsModuleClassesEdit extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ds_module_classes_edit);
        ...
        updatedDriveLinkBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(DsModuleClassesEdit.this);
    ...
    private void validateData() {
        ...
        if(TextUtils.isEmpty(updatedDriveLink)){
            Toast.makeText(DsModuleClassesEdit.this, "Drive link empty" , Toast.LENGTH_SHORT).show();
        }else if(TextUtils.isEmpty(updatedClassName)){
            Toast.makeText(DsModuleClassesEdit.this, "class Name empty" , Toast.LENGTH_SHORT).show();
        }else{
        ...
        ref.child("DataStructure")
                ...
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void unused) {
                        ...
                        Toast.makeText(DsModuleClassesEdit.this, "Updated Drive Link And Class Number Successfully" , Toast.LENGTH_SHORT).show();
                    ...
                    public void onFailure(@NonNull Exception e) {
                        progressDialog.dismiss();
                        Toast.makeText(DsModuleClassesEdit.this, ""+e.getMessage() , Toast.LENGTH_SHORT).show();
