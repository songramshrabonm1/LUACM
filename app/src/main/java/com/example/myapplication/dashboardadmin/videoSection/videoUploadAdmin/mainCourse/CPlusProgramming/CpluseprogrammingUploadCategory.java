...
import com.example.myapplication.dashboardadmin.videoSection.videoUploadAdmin.mainCourse.CprogrammingUploadCategory;
...
public class CpluseprogrammingUploadCategory extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cpluseprogramming_upload_category);
    ...
    private void validateDatat() {
        ...
        if(TextUtils.isEmpty(ModuleName)){
            Toast.makeText(CpluseprogrammingUploadCategory.this, "Enter The Module Name" , Toast.LENGTH_SHORT).show();
        }else if(TextUtils.isEmpty(videoTitleName)){
            Toast.makeText(CpluseprogrammingUploadCategory.this, "Enter The Video Title" , Toast.LENGTH_SHORT).show();

        }else if(TextUtils.isEmpty(TodayTotalVideoCount)){
            Toast.makeText(CpluseprogrammingUploadCategory.this, "Enter The Total Video Number" , Toast.LENGTH_SHORT).show();

        }else if(TextUtils.isEmpty(InstructorNAme)){
            Toast.makeText(CpluseprogrammingUploadCategory.this, "Enter The Instructor Name" , Toast.LENGTH_SHORT).show();
        }else{
    ...
    private void UploadedModuleDatabase() {
        ...
        reference.child("CPlusProgramming")
                .child(""+timeStamp)
                .setValue(hashMap)
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void unused) {
                        ...
                        Toast.makeText(CpluseprogrammingUploadCategory.this, "Uploaded Module Successfully ", Toast.LENGTH_SHORT).show();
                    ...
                    public void onFailure(@NonNull Exception e) {
                        progressDialog.dismiss();
                        Toast.makeText(CpluseprogrammingUploadCategory.this,  ""+e.getMessage(), Toast.LENGTH_SHORT).show();
