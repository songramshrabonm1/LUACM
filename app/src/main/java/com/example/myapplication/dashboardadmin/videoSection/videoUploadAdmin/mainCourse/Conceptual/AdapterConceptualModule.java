...
import com.example.myapplication.dashboardadmin.videoSection.videoUploadAdmin.mainCourse.Algorithm.AlgoUploadCategoryEdit;
...
public class AdapterConceptualModule extends RecyclerView.Adapter<AdapterConceptualModule.ViewHolder> implements Filterable {

    private Context context;
    public ArrayList<ModelConceptualModule> categoryModule , filterList;
    private ProgressDialog progressDialog;
    private com.example.myapplication.dashboardadmin.videoSection.videoUploadAdmin.mainCourse.Conceptual.FilterConceptualModule filter ;
    private String UserType = "";

    public AdapterConceptualModule(Context context, ArrayList<ModelConceptualModule> categoryModule , String UserType) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        ModelConceptualModule  modelCppModule = categoryModule.get(position);
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(context, ConceptualModuleClass.class);
        ...
        if(UserType.equals("ADMIN")) {
            ...
            holder.edit.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    Intent intent = new Intent(context, ConceptualUploadCategoryEdit.class);
                    intent.putExtra("id", id); // Data pass kortesi
                    intent.putExtra("module", moduleNumber);
                    intent.putExtra("VideoTitle", VideoTitle);
                    intent.putExtra("instructorName", instructorName);
...
//                Toast.makeText(context, "Hello I am the edit btn ", Toast.LENGTH_SHORT).show();
    ...
    private void DeleteModule(ModelConceptualModule modelCppModule, ViewHolder holder) {
    ...
    public Filter getFilter() {
        if(filter == null){
            filter = new  FilterConceptualModule(filterList , AdapterConceptualModule.this);
