...
//    String uid, id, title , description , categoryId, url ;
    ...
    public ModelPdf(String uid,String Year ,   String id, String Batch,  String Category,String SemesterExam , String SessionName , String categoryId, String url, long timestamp) {
        this.uid = uid;
        this.id = id;
        this.Batch = Batch;
