...
public class ConceptualModuleClass extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_conceptual_module_class);
        ...
        if(UserType.equals("ADMIN")) {
            ...
            AddingCls.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    Intent intent = new Intent(ConceptualModuleClass.this, ConceptualModuleClasses.class);
...
//                Toast.makeText(CppproggramingModuleClass.this, "Adding class Button " , Toast.LENGTH_SHORT).show();
    ...
    private void loadClassess() {
        ArrayList<ConceptualModelClasses> classessCategory = new ArrayList<>();
//        ArrayList<ConceptualModelClasses> classessCategory = new ArrayList<>();
                ...
                .addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        ...
                        for(DataSnapshot ds : snapshot.getChildren()){
                            recyclerView.setLayoutManager(new LinearLayoutManager(ConceptualModuleClass.this));
                            ConceptualModelClasses model = ds.getValue(ConceptualModelClasses.class);
                            classessCategory.add(model);
                        }
                        AdapterConceptualModuleClasses adapterAlgoModuleClasses = new AdapterConceptualModuleClasses(classessCategory, ConceptualModuleClass.this , UserType);
