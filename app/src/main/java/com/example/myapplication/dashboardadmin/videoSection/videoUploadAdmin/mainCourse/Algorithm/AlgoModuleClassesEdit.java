...
import com.example.myapplication.dashboardadmin.videoSection.videoUploadAdmin.mainCourse.CPlusProgramming.CppprogrammingModuleClassesEdit;
...
public class AlgoModuleClassesEdit extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_algo_module_classes_edit);
        ...
        updatedDriveLinkBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(AlgoModuleClassesEdit.this);
    ...
    private void validateData() {
        ...
        if(TextUtils.isEmpty(updatedDriveLink)){
            Toast.makeText(AlgoModuleClassesEdit.this, "Drive link empty" , Toast.LENGTH_SHORT).show();
        }else if(TextUtils.isEmpty(updatedClassName)){
            Toast.makeText(AlgoModuleClassesEdit.this, "class Name empty" , Toast.LENGTH_SHORT).show();
        }else{
        ...
        ref.child("Algo")
                ...
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void unused) {
                        ...
                        Toast.makeText(AlgoModuleClassesEdit.this, "Updated Drive Link And Class Number Successfully" , Toast.LENGTH_SHORT).show();
                    ...
                    public void onFailure(@NonNull Exception e) {
                        progressDialog.dismiss();
                        Toast.makeText(AlgoModuleClassesEdit.this, ""+e.getMessage() , Toast.LENGTH_SHORT).show();
