...
public class CprogrammingUploadCategory extends AppCompatActivity {

    AppCompatButton ModuleCreateBtn;
    ImageButton backButtonC;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cprogramming_upload_category);
    ...
    private void validateDatat() {
        ...
        if(TextUtils.isEmpty(ModuleName)){
            Toast.makeText(CprogrammingUploadCategory.this, "Enter The Module Name" , Toast.LENGTH_SHORT).show();
        }else if(TextUtils.isEmpty(videoTitleName)){
            Toast.makeText(CprogrammingUploadCategory.this, "Enter The Video Title" , Toast.LENGTH_SHORT).show();

        }else if(TextUtils.isEmpty(TodayTotalVideoCount)){
            Toast.makeText(CprogrammingUploadCategory.this, "Enter The Total Video Number" , Toast.LENGTH_SHORT).show();

        }else if(TextUtils.isEmpty(InstructorNAme)){
            Toast.makeText(CprogrammingUploadCategory.this, "Enter The Instructor Name" , Toast.LENGTH_SHORT).show();
        }else{
        ...
        reference.child("CProgramming")
                ...
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void unused) {
                        ...
                        Toast.makeText(CprogrammingUploadCategory.this, "Uploaded Module Successfully ", Toast.LENGTH_SHORT).show();
                    ...
                    public void onFailure(@NonNull Exception e) {
                        progressDialog.dismiss();
                        Toast.makeText(CprogrammingUploadCategory.this,  ""+e.getMessage(), Toast.LENGTH_SHORT).show();
