...
public class AdapterCModule extends RecyclerView.Adapter<AdapterCModule.ViewHolder> implements Filterable{


   private Context context;
   public ArrayList<ModelCModule> categoryModule , filterList;
    private ProgressDialog progressDialog;
    private com.example.myapplication.dashboardadmin.videoSection.videoUploadAdmin.mainCourse.FilterCModule filter ;
     String UserType = "";

    public AdapterCModule(Context context, ArrayList<ModelCModule> categoryModule , String UserType) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ModelCModule modelcModule = categoryModule.get(position);
        String instructorName = modelcModule.getInstructorName();
        String moduleNumber = modelcModule.getModule();
        String VideoTitle = modelcModule.getVideoTitle();
        String TotalVideoCnt = ""+modelcModule.getTotalVideo();
        String id = modelcModule.getId();
        String uid = modelcModule.getUid();
        long timestamp = modelcModule.getTimeStamp();
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(context, CproggramingModuleClass.class);
...
//                Toast.makeText(context, "Hello I am Item ", Toast.LENGTH_SHORT).show();
        ...
        if(UserType.equals("ADMIN")) {
            System.out.println("EiTa jehetu Admin tai vitore dukheche "+ UserType);
                    ...
                    builder.setTitle("Delete")
                            ...
                            .setPositiveButton("Confirmed", new DialogInterface.OnClickListener() {
                                ...
                                public void onClick(DialogInterface dialogInterface, int i) {
                                    DeleteModule(modelcModule, holder);
        ...
        if(UserType.equals("ADMIN")) {
            ...
            holder.edit.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    Intent intent = new Intent(context, CprogrammingUploadCategoryEdit.class);
                    intent.putExtra("id", id); // Data pass kortesi
                    intent.putExtra("module", moduleNumber);
                    intent.putExtra("VideoTitle", VideoTitle);
                    intent.putExtra("instructorName", instructorName);
                    intent.putExtra("TotalVideoCount", "" + modelcModule.getTotalVideo());
    ...
    private void DeleteModule(ModelCModule modelcModule, ViewHolder holder) {
    ...
    public Filter getFilter() {
        if(filter == null){
            filter = new FilterCModule(filterList, AdapterCModule.this);
