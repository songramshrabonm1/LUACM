...
public class AdapterAlgoModuleClasses extends RecyclerView.Adapter<AdapterAlgoModuleClasses.ViewHolder>{


    ArrayList<AlgoModelClasses> moduleClassesCategory = new ArrayList<>();
    private Context context;
    private ProgressDialog progressDialog;
    private String UserType = "";

    public AdapterAlgoModuleClasses(ArrayList<AlgoModelClasses> moduleClassesCategory, Context context , String UserType) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        AlgoModelClasses modelClasses = moduleClassesCategory.get(position);
        ...
        if(UserType.equals("ADMIN")) {
            ...
            holder.editBtn.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    Intent intent = new Intent(context, AlgoModuleClassesEdit.class);
    ...
    private void DeleteClasss(AlgoModelClasses modelClasses, ViewHolder holder) {
