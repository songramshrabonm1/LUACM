...
public class AlgoUploadCategoryEdit extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_algo_upload_category_edit);
    ...
    private void validatedData() {
        ...
        if(TextUtils.isEmpty(UpdateModule)){
            Toast.makeText(AlgoUploadCategoryEdit.this, "Update Module" , Toast.LENGTH_SHORT).show();
        }else if(TextUtils.isEmpty(VideoTitle)){
            Toast.makeText(AlgoUploadCategoryEdit.this, "Update Video Title" , Toast.LENGTH_SHORT).show();
        }else if(TextUtils.isEmpty(UpdateTotalVideoCnt)){
            Toast.makeText(AlgoUploadCategoryEdit.this, "Update Total Video count" , Toast.LENGTH_SHORT).show();
        }else if(TextUtils.isEmpty(UpdateInstructorName)){
            Toast.makeText(AlgoUploadCategoryEdit.this, "Update Instructor Name" , Toast.LENGTH_SHORT).show();
        ...
        ref.child("Algo")
                ...
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void unused) {
                        ...
                        Toast.makeText(AlgoUploadCategoryEdit.this, "Updating Module succefully..." , Toast.LENGTH_SHORT).show();
                    ...
                    public void onFailure(@NonNull Exception e) {
                        ...
                        progressDialog.dismiss();
                        Toast.makeText(AlgoUploadCategoryEdit.this, ""+e.getMessage() , Toast.LENGTH_SHORT).show();
