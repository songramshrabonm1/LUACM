...
public class AdapterDailyContestModuleClasses extends RecyclerView.Adapter<AdapterDailyContestModuleClasses.ViewHolder> {

    ArrayList<DailyModelClasses> moduleClassesCategory = new ArrayList<>();
    private Context context;
    private ProgressDialog progressDialog;
    private String UserType= "";


    public AdapterDailyContestModuleClasses(ArrayList<DailyModelClasses> moduleClassesCategory, Context context , String UserType) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        DailyModelClasses modelClasses = moduleClassesCategory.get(position);
        ...
        if(UserType.equals("ADMIN")) {
            ...
            holder.editBtn.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    Intent intent = new Intent(context, DailyModuleClassesEdit.class);
    ...
    private void DeleteClasss(DailyModelClasses modelClasses, ViewHolder holder) {
