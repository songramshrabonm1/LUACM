...
public class AdapterDsModuleClasses extends RecyclerView.Adapter<AdapterDsModuleClasses.ViewHolder> {


    ArrayList<DsModelClasses> moduleClassesCategory = new ArrayList<>();
    private Context context;
    private ProgressDialog progressDialog;
    private String UserType = "";

    public AdapterDsModuleClasses(ArrayList<DsModelClasses> moduleClassesCategory, Context context , String UserType) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        DsModelClasses modelClasses = moduleClassesCategory.get(position);
        ...
        if(UserType.equals("ADMIN")) {
            ...
            holder.editBtn.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    Intent intent = new Intent(context, DsModuleClassesEdit.class);
    ...
    private void DeleteClasss(DsModelClasses modelClasses, ViewHolder holder) {
