...
public class CppprogrammingModuleClasses extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cppprogramming_module_classes);


        id = getIntent().getStringExtra("id");

        progressDialog = new ProgressDialog(CppprogrammingModuleClasses.this);
        ...
        addDriveLinkBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(CppprogrammingModuleClasses.this);
    ...
    private void validateData() {
        ...
        if(TextUtils.isEmpty(driveLink)){
            Toast.makeText(CppprogrammingModuleClasses.this, "Your Drive Link Edit Text Empty . It was mentioned at the beginning to repeatedly check whether your drive link is accurate or not." , Toast.LENGTH_SHORT).show();

        }else if(TextUtils.isEmpty(classNumber)){
            Toast.makeText(CppprogrammingModuleClasses.this, "Your Class Edit TExt Empty" , Toast.LENGTH_SHORT).show();
        }else{
...
//                .child(""+System.currentTimeMillis()) আর কোন সময় এভাবে Timestamp child এর মধ্যে add করব না যদি সেটি পরবর্তীতে আইডির জন্যে সেট করি । কারণ এভাবে দুইবার সেট করলে দুইটা আলাদা আলাদা টাইম সেট হয়ে জয় এর ফলে সেম না হওয়ার জন্যে আমরা এগুলোকে ধরে ফেচ করতি সমসম্যা  হয়ে যাবে ।
                ...
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void unused) {
                        ...
                        Toast.makeText(CppprogrammingModuleClasses.this, "Uploaded Class Drive Link Successfully" , Toast.LENGTH_SHORT).show();
                    ...
                    public void onFailure(@NonNull Exception e) {
                        progressDialog.dismiss();
                        Toast.makeText(CppprogrammingModuleClasses.this, ""+e.getMessage() , Toast.LENGTH_SHORT).show();
