...
public class ModelAlgoModule {

    String   InstructorName = "",  Module = "" , TotalVideo ="", VideoTitle ="" , id = "" , uid = "";
    long timeStamp ;
    public ModelAlgoModule() {
    }

    public ModelAlgoModule(String instructorName, String module, String totalVideo, String videoTitle, String id, String uid, long timeStamp) {
