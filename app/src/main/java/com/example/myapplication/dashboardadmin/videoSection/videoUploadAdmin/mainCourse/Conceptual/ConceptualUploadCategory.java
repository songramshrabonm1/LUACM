...
public class ConceptualUploadCategory extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_conceptual_upload_category);
    ...
    private void validateDatat() {
        ...
        if(TextUtils.isEmpty(ModuleName)){
            Toast.makeText(ConceptualUploadCategory.this, "Enter The Module Name" , Toast.LENGTH_SHORT).show();
        }else if(TextUtils.isEmpty(videoTitleName)){
            Toast.makeText(ConceptualUploadCategory.this, "Enter The Video Title" , Toast.LENGTH_SHORT).show();

        }else if(TextUtils.isEmpty(TodayTotalVideoCount)){
            Toast.makeText(ConceptualUploadCategory.this, "Enter The Total Video Number" , Toast.LENGTH_SHORT).show();

        }else if(TextUtils.isEmpty(InstructorNAme)){
            Toast.makeText(ConceptualUploadCategory.this, "Enter The Instructor Name" , Toast.LENGTH_SHORT).show();
        }else{
        ...
        reference.child("Conceptual")
                ...
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void unused) {
                        ...
                        Toast.makeText(ConceptualUploadCategory.this, "Uploaded Module Successfully ", Toast.LENGTH_SHORT).show();
                    ...
                    public void onFailure(@NonNull Exception e) {
                        progressDialog.dismiss();
                        Toast.makeText(ConceptualUploadCategory.this,  ""+e.getMessage(), Toast.LENGTH_SHORT).show();
