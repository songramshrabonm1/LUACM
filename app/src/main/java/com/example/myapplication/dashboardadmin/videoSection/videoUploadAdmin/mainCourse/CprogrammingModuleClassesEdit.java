...
public class CprogrammingModuleClassesEdit extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cprogramming_module_classes_edit);
        ...
        updatedDriveLinkBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(CprogrammingModuleClassesEdit.this);
    ...
    private void validateData() {
        ...
        if(TextUtils.isEmpty(updatedDriveLink)){
            Toast.makeText(CprogrammingModuleClassesEdit.this, "Drive link empty" , Toast.LENGTH_SHORT).show();
        }else if(TextUtils.isEmpty(updatedClassName)){
            Toast.makeText(CprogrammingModuleClassesEdit.this, "class Name empty" , Toast.LENGTH_SHORT).show();
        }else{
        ...
        ref.child("CProgramming")
                ...
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void unused) {
                        ...
                        Toast.makeText(CprogrammingModuleClassesEdit.this, "Updated Drive Link And Class Number Successfully" , Toast.LENGTH_SHORT).show();
                    ...
                    public void onFailure(@NonNull Exception e) {
                        progressDialog.dismiss();
                        Toast.makeText(CprogrammingModuleClassesEdit.this, ""+e.getMessage() , Toast.LENGTH_SHORT).show();
