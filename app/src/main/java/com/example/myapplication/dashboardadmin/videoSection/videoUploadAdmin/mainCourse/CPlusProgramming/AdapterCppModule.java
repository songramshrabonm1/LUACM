...
import com.example.myapplication.dashboardadmin.videoSection.videoUploadAdmin.mainCourse.AdapterCModule;
...
import com.example.myapplication.dashboardadmin.videoSection.videoUploadAdmin.mainCourse.FilterCModule;
...
public class AdapterCppModule extends RecyclerView.Adapter<AdapterCppModule.ViewHolder> implements Filterable {

    private Context context;
    public ArrayList<ModelCppModule> categoryModule , filterList;
    private ProgressDialog progressDialog;
    private com.example.myapplication.dashboardadmin.videoSection.videoUploadAdmin.mainCourse.CPlusProgramming.FilterCppModule filter ;
    private String UserType = "";


    public AdapterCppModule(Context context, ArrayList<ModelCppModule> categoryModule , String UserType)  {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ModelCppModule modelCppModule = categoryModule.get(position);
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(context, CppproggramingModuleClass.class);
        ...
        if(UserType.equals("ADMIN")) {
            holder.edit.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    Intent intent = new Intent(context, CppProgrammingUploadCategoryEdit.class);
                    intent.putExtra("id", id); // Data pass kortesi
                    intent.putExtra("module", moduleNumber);
                    intent.putExtra("VideoTitle", VideoTitle);
                    intent.putExtra("instructorName", instructorName);
...
//                Toast.makeText(context, "Hello I am the edit btn ", Toast.LENGTH_SHORT).show();
    ...
    private void DeleteModule(ModelCppModule modelCppModule, ViewHolder holder) {
    ...
    public Filter getFilter() {
        if(filter == null){
            filter = new FilterCppModule(filterList, AdapterCppModule.this);
