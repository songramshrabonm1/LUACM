...
public class DsUploadCategoryEdit extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ds_upload_category_edit);
    ...
    private void validatedData() {
        ...
        if(TextUtils.isEmpty(UpdateModule)){
            Toast.makeText(DsUploadCategoryEdit.this, "Update Module" , Toast.LENGTH_SHORT).show();
        }else if(TextUtils.isEmpty(VideoTitle)){
            Toast.makeText(DsUploadCategoryEdit.this, "Update Video Title" , Toast.LENGTH_SHORT).show();
        }else if(TextUtils.isEmpty(UpdateTotalVideoCnt)){
            Toast.makeText(DsUploadCategoryEdit.this, "Update Total Video count" , Toast.LENGTH_SHORT).show();
        }else if(TextUtils.isEmpty(UpdateInstructorName)){
            Toast.makeText(DsUploadCategoryEdit.this, "Update Instructor Name" , Toast.LENGTH_SHORT).show();
        ...
        ref.child("DataStructure")
                ...
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void unused) {
                        ...
                        Toast.makeText(DsUploadCategoryEdit.this, "Updating Module succefully..." , Toast.LENGTH_SHORT).show();
                    ...
                    public void onFailure(@NonNull Exception e) {
                        ...
                        progressDialog.dismiss();
                        Toast.makeText(DsUploadCategoryEdit.this, ""+e.getMessage() , Toast.LENGTH_SHORT).show();
